...
func _init_towns() -> void:
	towns = {
		"Ashford": {
			...
			"production_plan": {"wheat": 6, "wood": 4, "flour": 2, "bread": 3},
		...
		"Ironmere": {
			...
			"production_plan": {"iron_ore": 5, "iron_bar": 2, "tool": 1, "sword": 1, "wheat": 2},
		...
		"Stonebridge": {
			...
			"production_plan": {"grapes": 7, "must": 2, "wine": 1, "wood": 3, "wheat": 2},
